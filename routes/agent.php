...
use App\Http\Controllers\Agent\MakePaymentUsingQRCodeController;
...
use App\Http\Controllers\Agent\TransferMoneyController;
...
Route::prefix("agent")->name("agent.")->group(function(){
    ...
    //qrcode
    Route::controller(QRCodeController::class)->prefix('qr-codes')->name('qrcode.')->group(function(){
        Route::get('/','index')->name('index');
    });

    // make payment using qrcode
    Route::controller(MakePaymentUsingQRCodeController::class)->prefix('make-payment-using-qrcode')->name('make.payment.using.qrcode.')->group(function(){
        Route::get('/','index')->name('index');
        Route::post('confirm/{slug}','confirm')->name('confirmed');
    });
    //transactions
