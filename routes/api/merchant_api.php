...
use App\Http\Controllers\Api\Merchant\BulkMoneyTransferController;
...
use App\Http\Controllers\Api\Merchant\QRCodeGenerateController;
...
Route::prefix('merchant')->group(function(){
    ...
    Route::middleware(['merchant.api'])->group(function(){
        ...
        Route::post('send-sms-code', [AuthorizationController::class,'sendSMSCode']);
        ...
        Route::middleware(['CheckStatusApiMerchant','merchant.google.two.factor.api'])->group(function () {
            ...
            //bulk money transfer
            Route::controller(BulkMoneyTransferController::class)->prefix('bulk-money-transfer')->group(function(){
                Route::get('/','index');
                Route::post('upload','upload');
                Route::post('submit','submit');
                Route::get('log-download','download');
            });
            //qrcode generator
            Route::controller(QRCodeGenerateController::class)->prefix('qr-code-generator')->group(function(){
                Route::post('store','store');
                Route::get('all-qrcodes','allQrCodes');
            });
            //transactions
