...
use App\Http\Controllers\Api\Agent\QRCodesController;
...
Route::prefix('agent')->group(function(){
    ...
    Route::middleware(['agent.api'])->group(function(){
        ...
        Route::middleware(['agent.google.two.factor.api'])->group(function () {
            ...
            //qr code
            Route::controller(QRCodesController::class)->prefix('qr-code')->group(function(){
                Route::get('/','index');
            });
            //transactions
