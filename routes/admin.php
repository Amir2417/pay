...
use App\Http\Controllers\Admin\BulkMoneyTransferLogController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::controller(BulkMoneyTransferLogController::class)->prefix('bulk-money-transfer-log')->name('bulk.money.transfer.logs.')->group(function(){
        Route::get('/','index')->name('index');
    ...
    Route::controller(SetupSmsController::class)->prefix('setup-sms')->name('setup.sms.')->group(function () {
        ...
        Route::post('test-sms/send','sendTestSms')->name('test.code.send')->middleware('sms');
    });
