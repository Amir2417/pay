...
Route::controller(SiteController::class)->group(function(){
    ...
    Route::post('check-user-unique-user-name','checkUserUniqueName')->name('check.user.unique.user.name');
    Route::post('check-agent-unique-user-name','checkAgentUniqueName')->name('check.agent.unique.user.name');
    Route::post('check-merchant-unique-user-name','checkMerchantUniqueName')->name('check.merchant.unique.user.name');
});
