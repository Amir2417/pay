        ...
        <div class="account-wrapper kyc">
            ...
            <form class="account-form" action="{{ setRoute('agent.register.submit') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row ml-b-20">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-4 form-group">
                        <input type="text" name="username" class="form--control user-name" placeholder="Username" value="{{ old('username') }}">  
...
<script>
      getAllCountries("{{ setRoute('global.countries') }}");
        ...
        $('.user-name').keyup(function () { 
           ...
           var checkUniqueUserNameURL   = "{{ route('check.agent.unique.user.name') }}";
