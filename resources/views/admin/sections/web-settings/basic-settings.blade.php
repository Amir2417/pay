                ...
                <div class="card-inner-body">
                    <div class="row mb-10-none">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __( "SMS Verification"),
                                'name'          => 'agent_sms_verification',
                                'value'         => old('agent_sms_verification',$basic_settings->agent_sms_verification),
                               'options'       => [__("Activated") => 1, __("Deactivated") => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __( "SMS Notification"),
                                'name'          => 'agent_sms_notification',
                                'value'         => old('agent_sms_notification',$basic_settings->agent_sms_notification),
                               'options'       => [__("Activated") => 1, __("Deactivated") => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                ...
                <div class="card-inner-body">
                    <div class="row mb-10-none">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __( "SMS Verification"),
                                'name'          => 'merchant_sms_verification',
                                'value'         => old('merchant_sms_verification',$basic_settings->merchant_sms_verification),
                               'options'       => [__("Activated") => 1, __("Deactivated") => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 form-group">
                            @include('admin.components.form.switcher',[
                                'label'         => __( "SMS Notification"),
                                'name'          => 'merchant_sms_notification',
                                'value'         => old('merchant_sms_notification',$basic_settings->merchant_sms_notification),
                               'options'       => [__("Activated") => 1, __("Deactivated") => 0],
                                'onload'        => true,
                                'permission'    => "admin.web.settings.basic.settings.activation.update",
                            ])
