        ...
        <div class="sidebar-menu-inner-wrapper">
            ...
            <div class="sidebar-menu-wrapper">
                <ul class="sidebar-menu">
                    ...
                    <li class="sidebar-menu-item">
                        <a href="{{ setRoute('merchant.bulk.money.transfer.index') }}">
                            <i class="menu-icon fas fa-money-bill-wave"></i>
                            <span class="menu-title">{{ __("Bulk Money Transfer") }}</span>
                        </a>
                    </li>
                    <li class="sidebar-menu-item">
                        <a href="{{ setRoute('merchant.qrcode.generate.index') }}">
                            <i class="menu-icon fas fa-qrcode"></i>
                            <span class="menu-title">{{ __("QRCodes") }}</span>
                        </a>
                    </li>
