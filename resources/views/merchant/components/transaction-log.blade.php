                    ...
                    <div class="dashboard-list-user-wrapper">
                        ...
                        <div class="dashboard-list-user-content">
                            ...
                            @elseif ($item->type == payment_gateway_const()::BULKMONEYTRANSFER)
                                <h4 class="title">{{ __('Bulk Money Transfer') }}</h4>
                            @endif
                ...
                @else
                    ...
                    <div class="preview-list-item">
                        ...
                        <div class="preview-list-right">
                            ...
                            @elseif ($item->type == payment_gateway_const()::BULKMONEYTRANSFER)
                                <span class="text--warning"><a href="{{ setRoute('merchant.bulk.money.transfer.transaction.log.download',['bmt_id' => $item->bmt_id]) }}" class="btn--base">{{ __("Download") }}</a></span>
                            @elseif ($item->type == payment_gateway_const()::TYPEMONEYOUT)
                                <span class="text--danger">{{ get_amount($item->available_balance,get_default_currency_code()) }}</span>
                            @elseif ($item->type == payment_gateway_const()::BILLPAY)
                                <span class="text--danger">{{ get_amount($item->available_balance,get_default_currency_code()) }}</span>
