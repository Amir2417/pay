                                ...
                                <div class="form-group">
                                    ...
                                    <select class="select2-auto-tokenize currency_link" name="currency">
                                        ...
                                        @foreach ($currency_data as $item)
                                            @isset($item->currency_code)
                                                <option value="{{ $item->currency_code }}" data-country="{{ $item->country }}" data-currency_name="{{ $item->currency_name }}" data-currency_code="{{ $item->currency_code }}" data-currency_symbol="{{ $item->currency_symbol }}">{{ $item->currency_code.' - '.$item->currency_name }}</option>
                                            @endisset
                                        @endforeach
                                    </select>
                                </div>
