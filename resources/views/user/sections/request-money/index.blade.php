                        ...
                        <form class="card-form" action="{{ setRoute('user.request.money.submit') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-6 col-xl-12 col-lg-6 form-group paste-wrapper">
                                    <label>{{ __("Phone Number") }} ({{ __("User") }})<span class="text--base">*</span></label>
                                ...
                                <div class="col-xxl-6 col-xl-12 col-lg-6 form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form--control number-input" id="amount" required placeholder="{{ __("Enter Request Amount") }}" name="request_amount" value="{{ old("request_amount") }}">
