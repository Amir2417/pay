                        ...
                        <form class="card-form" action="{{ setRoute('user.agent.money.out.confirmed') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xxl-6 col-xl-12 col-lg-6 form-group paste-wrapper">
                                    <label>{{ __("Phone Number") }} ({{ __("Agent") }})<span class="text--base">*</span></label>
                                ...
                                <div class="col-xxl-6 col-xl-12 col-lg-6 form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form--control number-input" required placeholder="{{ __("enter Amount") }}" name="amount" id="amount" value="{{ old("amount") }}">
...
//  'use strict'
    (function ($) {
        ...
        function amountValueSet(amount){
...
<script>
     ...
     var defualCurrencyRate = "{{ get_default_currency_rate() }}";
        ...
        function getFees() {
            ...
            $(".fees-show").html("{{ __('Money Out Fee') }}: " + parseFloat(charges.fixed).toFixed(2) + " " + currencyCode + " + " + parseFloat(charges.percent).toFixed(2) + "%  ");
        }
        function getPreview() {
