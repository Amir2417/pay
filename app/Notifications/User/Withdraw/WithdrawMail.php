...
class WithdrawMail extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ...
                    ->line("Request Amount: " . getAmount($data->amount,2).' '.get_default_currency_code())
                    ->line("Exchange Rate: " ." 1 ". get_default_currency_code().' = '. getAmount($data->gateway_rate,2).' '.$data->gateway_currency)
                    ->line("Fees & Charges: " . getAmount($data->gateway_charge,2).' '.$data->gateway_currency)
                    ->line("Will Get: " .  get_amount($data->will_get,$data->gateway_currency,'',2))
