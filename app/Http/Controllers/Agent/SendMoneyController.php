            ...
            if($receiverTrans){
                 ...
                 try{
                    ...
                    if( $basic_setting->agent_sms_notification == true){
                        ...
                        $message = __("Received Money" . " "  . getAmount($charges['receiver_amount'],4) . ' ' . $charges['receiver_currency'] .  ", from " . @$sender_wallet->agent->username . " " . "Transaction ID: " . $trx_id . ' ' . "Date : " . Carbon::now()->format('Y-m-d'));
