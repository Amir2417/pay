            ...
            if($sender){
                ...
                try{
                    ...
                    if( $auth_user->email_verified == false && $auth_user->sms_verified == true){
                        ...
                        $message = __("Money In" . " "  . get_amount($charges['sender_amount'],2) . ' ' . $charges['sender_currency'] .  ", to " . @$receiver_wallet->user->username . " " . "Transaction ID: " . $trx_id . ' ' . "Date : " . Carbon::now()->format('Y-m-d'));
