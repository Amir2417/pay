...
use App\Http\Resources\Merchant\BulkMoneyLogs;
...
class TransactionController extends Controller
{
    ...
    public function index($slug = null) {
        ...
        $bulk_money            = Transaction::merchantAuth()->bulkMoney()->orderByDesc('id')->get();
        ...
        $transactions = [
            ...
            'bulk_money'        => BulkMoneyLogs::collection($bulk_money),
        ];
        ...
        $transaction_types = [
            ...
            'bulk_money'            => PaymentGatewayConst::BULKMONEYTRANSFER,
