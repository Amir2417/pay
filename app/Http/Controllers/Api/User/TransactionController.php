...
use App\Http\Resources\User\BulkMoneyTransferLogs;
...
class TransactionController extends Controller
{
    public function slugValue($slug) {
        $values =  [
            ...
            'bulk-money-transfer'   => PaymentGatewayConst::BULKMONEYTRANSFER,
    ...
    public function index($slug = null) {
        ...
        $bulkMoneyTransfer      = Transaction::auth()->bulkMoney()->orderByDesc("id")->get();
