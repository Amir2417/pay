...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'sms'                                   => \App\Http\Middleware\Admin\SMSGuard::class,
        ...
        'sms.verification.guard'                => \App\Http\Middleware\SMSVerificationGuard::class,
        'verification.guard.merchant'           => \App\Http\Middleware\Merchant\VerificationGuard::class,
        'sms.verification.guard.merchant'       => \App\Http\Middleware\Merchant\SMSVerificationGuard::class,
        ...
        'sms.verification.guard.agent'          => \App\Http\Middleware\Agent\SMSVerificationGuard::class,
